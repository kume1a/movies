  ...
  static FutureOr<void> _onCreate(Database db, int version) async {
    ...
    db.execute('''
      ...
      (
        ...
        ${TableSearchResults.columnNameKa} TEXT NOT NULL,
        ${TableSearchResults.columnNameEn} TEXT NOT NULL,
        ${TableSearchResults.columnDescriptionKa} TEXT NOT NULL,
        ${TableSearchResults.columnDescriptionEn} TEXT NOT NULL,
