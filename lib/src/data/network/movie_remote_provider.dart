...
class MovieRemoteProvider {
  ...
  Future<Option<MovieData>> fetchMovie(int movieId) async {
    const Map<String, String> params = <String, String>{'filters[with_directors]': '3', 'source': 'adjaranet'};
  ...
  Future<Option<SeasonFiles>> fetchSeasonFiles(int id, int season) async {
    ...
    try {
      ...
      final SeasonFilesSchema schema = SeasonFilesSchema.fromJson(jsonDecode(json) as Map<String, dynamic>);
  ...
  Future<Option<SearchResults>> search(String keyword, int page) async {
    ...
    try {
      ...
      final SearchResultsSchema schema = SearchResultsSchema.fromJson(jsonDecode(json) as Map<String, dynamic>);
